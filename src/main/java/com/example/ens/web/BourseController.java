...
public class BourseController {
    ...
    @PutMapping("/id")
    public BourseDTO updateBourse(@PathVariable Long id,@RequestBody BourseDTO bourseDTO) throws BourseException{
        bourseDTO.setId(id);
        return service.updateBourse(bourseDTO);
    }
    @GetMapping("/id")
    public BourseDTO getBourseById(@PathVariable Long id) throws BourseException{
    ...
    @DeleteMapping("/id")
    public void deletBourse(@PathVariable Long id) throws BourseException{
